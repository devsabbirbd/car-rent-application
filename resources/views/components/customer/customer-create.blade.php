...
<div  class="modal fade" id="create-modal" tabindex="-1"  data-bs-backdrop="static">
            ...
            <div class="modal-content">
                <div class="card px-2">
                    <div class="card-body">
                        ...
                        <br/>
                        <button onclick="onRegistration()" class="btn w-100 bg-gradient-info">Create Account</button>
                    </form>
                    </div>
                </div>
            </div>
