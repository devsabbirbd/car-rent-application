...
@section('content')
    ...
    <div class="container my-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="https://media-cldnry.s-nbcnews.com/image/upload/t_fit-1240w,f_auto,q_auto:best/newscms/2019_13/2798361/190325-rental-cars-cs-229p.jpg" class="img-fluid rounded w-100" alt="Car Rental">
            </div>
        </div>
    </div>
